...
import authorsPageInitialPathsF2740Resource from '../../../resources/authors-page-initial-paths-f2740'
import authorsPageInitialProps87137Resource from '../../../resources/authors-page-initial-props-87137'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPathsF2740Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await authorsPageInitialProps87137Resource({
      ...context?.params,
